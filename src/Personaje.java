public class Personaje {
    ...
    public void recibirAtaque(Personaje atacante){
        System.out.println("\n\n" + atacante.getNombre() + " ataca a "+ this.getNombre()+ "\n\n");
        ...
        System.out.println(""+atacante.getNombre()+  " atacó a  " + this.getNombre() + " el daño hecho: " + danyoRecibido  + " le queda vida: "+this.getVida());
    }
